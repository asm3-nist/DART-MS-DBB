...
##
## Generates library as general-purpose text (.SDF).
## 
...
##
## Version 1.0 
## Revision Date: September 15th, 2020
## =====================================================================

# Setup
rm(list=ls())

header = "NIST DART-MS Database Builder v.1.0\nRevised September 17th, 2020."
cat(header)
cat("\n\n")
...
NISTDST = FALSE; # create an RDS file for NIST DST use 1
...
## MAIN CODE 
  ...
  PotentialBPs = numeric(nCompounds) # potential base peaks
